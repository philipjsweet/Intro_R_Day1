...
__Write some text that is bold, and some that is in italics__
...
__2. Make a numbered list and a bulleted list__
...
__3. Make a nested list.__

  1. A
  1. Nested 
      + List
 
__bold__ 4. Try the block-quote feature. __bold__
...
fav_food <- c("pizza","pizza","pizza","pizza","pizza")

num_food <- data.frame(rank = numbers, food = fav_food)
...
3. Use the `read_csv()` function to read the file, and save it as a data frame called `mushrooms`.
...
read.csv("mushrooms.csv", header = TRUE) %>% head(n=10) -> mushrooms_tiny
